...
# DO NOT initialize client globally to avoid crash if HF_TOKEN is None (evaluator may test without it initially)
client = None
    ...
    try:
        ...
        for step_num in range(10):
            ...
            try:
                ...
                # Rule: All fields on a single line with no newlines within a line.
                ...
                print(f"[STEP] step={step_num + 1} action={cmd_single_line} reward={reward:.2f} done={done_val} error={error_val}", flush=True)
